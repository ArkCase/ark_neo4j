...
ARG VER="4.4.24"
ARG BLD="01"
ARG PENTAHO_INSTALL_REPO="arkcase/pentaho-ee-install"
ARG PENTAHO_VER="9.4.0.0-343"
ARG NEO4J_KEY_URL="https://debian.neo4j.com/neotechnology.gpg.key"

FROM "${PRIVATE_REGISTRY}/${PENTAHO_INSTALL_REPO}:${PENTAHO_VER}" as src
...
ENV PENTAHO_PDI_HOME="${NEO4J_HOME}/pentaho-pdi"
...
COPY --from=src --chown=${NEO4J_USER}:${NEO4J_GROUP} /home/pentaho/app/pentaho-pdi "${PENTAHO_PDI_HOME}/"
